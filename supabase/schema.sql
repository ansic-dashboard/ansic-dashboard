...
select * from (values
  ('2026-02-27'::date, 'meta', '메타광고 1차', '드리븐 진행', 4362621,
    ...
    'completed'),
  ('2026-04-14'::date, 'meta', '메타광고 2차', '드리븐 진행 - 예산 초과 진행 중', 1906225,
...
select * from (values
  ...
  ('2026-04', '아야미 (Ayami)', '@ayamitakagi325', '일본인 인플루언서', '2.2만 (일본)', 250000, '', '2026-04-25'::date, '업로드 완료',
   ...
   '일본 관광객 시즌(여름·가을) + 강남 V-log 컨셉 재시도',
  ...
  ('2026-05', '최호준', '@trendyplace_curator', '트렌디 플레이스 큐레이터', '4.5만 마이크로', 800000, '', '2026-05-20'::date, '편집 중',
   ...
   '업로드 결과 본 후 판단',
   '{}'::jsonb),
  ('2026-05', '머스트잇 (Must Eat)', '@musteat_official', '맛집 큐레이션 (공식 계정)', '7.8만 마이크로', 650000, '', '2026-05-23'::date, '촬영 전',
   ...
   '5/23 촬영 후 평가',
   '{}'::jsonb),
  ('2026-05', '고민', '@koh_min_', '라이프스타일', '5.9만 마이크로', 800000, '', '2026-05-29'::date, '촬영 전',
